# We can also remove elements from a list using the pop() function. By default, pop() removes the last element from the list. We can also specify an index to remove a specific element.
